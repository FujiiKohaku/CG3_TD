...
void Bumper::Initialize(Vector3 position, float radius, float bounce, Object3dManager* object3dManager, const std::string& modelName)
{
	position_ = position;
	radius_ = radius;
	bounce_ = bounce;
...
bool Bumper::IsCollision(const Sphere& s1,const Sphere& s2)
{
	// 中心間ベクトルを計算
	Vector3 delta = {
...
void Bumper::ReflectSphereVelocity(Sphere& movingSphere, Vector3& velocity, const Sphere& staticSphere)
{
	Vector3 diff = {
